    ...
    private fun getSampleTextSummaries(): List<com.vedicvidya.data.model.TextSummary> {
        return listOf(
            com.vedicvidya.data.model.TextSummary(
                ...
                textId = "BG",
                textName = "Bhagavad Gita",
                level = com.vedicvidya.data.model.SummaryLevel.BOOK,
                parentId = null,
                chapter = null,
                section = null,
                summary = "The Bhagavad Gita is a 700-verse Hindu scripture that is part of the epic Mahabharata. It is a conversation between Prince Arjuna and Lord Krishna on the battlefield of Kurukshetra.",
                detailedSummary = "The Gita addresses the moral and philosophical dilemmas faced by Arjuna and provides profound spiritual wisdom on dharma, karma, bhakti, and jnana. It is divided into 18 chapters covering various yogas (paths) to self-realization.",
                keyThemes = listOf("dharma", "karma", "bhakti", "jnana", "yoga"),
                keyCharacters = listOf("Krishna", "Arjuna"),
                embedding = FloatArray(128) { 0.1f }.joinToString(","),
                verseCount = 700,
                verseRange = "1.1-18.78",
            ...
            com.vedicvidya.data.model.TextSummary(
                ...
                chapter = null,
                section = null,
                summary = "The Ramayana is an ancient Indian epic that narrates the life of Prince Rama, his wife Sita, and his devoted companion Hanuman.",
                detailedSummary = "It teaches about dharma, devotion, loyalty, and the triumph of good over evil through the story of Rama's exile and battle against the demon king Ravana. The epic is divided into seven kandas (books).",
                keyThemes = listOf("dharma", "devotion", "loyalty", "righteousness", "bhakti"),
                keyCharacters = listOf("Rama", "Sita", "Hanuman", "Ravana", "Lakshmana"),
                embedding = FloatArray(128) { 0.1f }.joinToString(","),
                verseCount = 24000,
                verseRange = "1.1-7.end",
            ...
            com.vedicvidya.data.model.TextSummary(
                ...
                chapter = null,
                section = null,
                summary = "The Mahabharata is the longest epic poem in the world, containing over 100,000 verses.",
                detailedSummary = "It narrates the story of the Kurukshetra War between the Pandavas and Kauravas, along with numerous philosophical and devotional teachings. The Bhagavad Gita is a part of this epic. It is divided into 18 parvas (books).",
                keyThemes = listOf("dharma", "war", "family", "duty", "righteousness"),
                keyCharacters = listOf("Yudhishthira", "Arjuna", "Bhima", "Duryodhana", "Krishna"),
                embedding = FloatArray(128) { 0.1f }.joinToString(","),
                verseCount = 100000,
                verseRange = "1.1-18.end",
